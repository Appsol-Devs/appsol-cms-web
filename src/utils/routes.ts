export const allRoutes = Object.freeze({
  ...
  ADD_SUBSCRIPTION_PAYMENT: (subscriptionId: string) => `/subscriptions/${subscriptionId}/payment/new`,
  PAYMENTS: "/payments",
  ...
  ADD_RESCHEDULE: "/schedules/new",
  UPDATE_RESCHEDULE: (id: string) => `/schedules/${id}`,
  VIEW_RESCHEDULE: (id: string) => `/schedules/${id}/view`,
  RESCHEDULES_SCHEDULER: "/schedules/scheduler",
  SETTINGS: "/settings",
