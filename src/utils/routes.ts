...
export const allRoutes = Object.freeze({
  ...
  ADD_RESCHEDULE: "/reschedules/new",
  UPDATE_RESCHEDULE: (id: string) => `/reschedules/${id}`,
  VIEW_RESCHEDULE: (id: string) => `/reschedules/${id}/view`,
  RESCHEDULES_SCHEDULER: "/reschedules/scheduler",
  SETTINGS: "/settings",
