...
interface IField {
  isLoading?: boolean;
  form: UseFormReturn<IComplaintTypeFields, any, IComplaintTypeFields>;
  isUpdate?: boolean;
}

const ComplaintTypesFormContent = ({ isLoading, form, isUpdate }: IField) => {
...
export default ComplaintTypesFormContent;
